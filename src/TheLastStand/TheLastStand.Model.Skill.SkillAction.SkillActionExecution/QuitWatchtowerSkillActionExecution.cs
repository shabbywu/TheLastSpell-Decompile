...
public class QuitWatchtowerSkillActionExecution : SkillActionExecution
{
	public QuitWatchtowerSkillActionExecution(SkillActionExecutionController skillExecutionController, SkillActionExecutionView skillExecutionView, Skill skill)
