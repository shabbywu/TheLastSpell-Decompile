...
public class FocusUnitCutsceneDefinition : TheLastStand.Framework.Serialization.Definition, ICutsceneDefinition
{
	...
	public override void Deserialize(XContainer container)
	{
		...
		if (val != null)
		{
			...
			CLoggerManager.Log((object)("Could not parse FocusUnitCutsceneDefinition ZoomIn value " + val.Value + " as a valid bool value."), (LogType)3, (CLogLevel)1, true, "StaticLog", false);
			ZoomIn = true;
		}
	}
}
