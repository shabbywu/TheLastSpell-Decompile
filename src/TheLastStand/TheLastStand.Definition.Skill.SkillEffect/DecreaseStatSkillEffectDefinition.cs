...
public class DecreaseStatSkillEffectDefinition : AffectingUnitSkillEffectDefinition
{
	...
	public float LossValue { get; private set; }
	...
	public DecreaseStatSkillEffectDefinition(XContainer container)
		: base(container)
	{
	}
	...
	public override void Deserialize(XContainer container)
	{
		...
		LossValue = float.Parse(((XContainer)val).Element(XName.op_Implicit("LossValue")).Value, NumberStyles.Float, CultureInfo.InvariantCulture);
