...
public class GlyphModifyCostsEffectDefinition : GlyphIntValueBasedEffectDefinition
{
	...
	public override void Deserialize(XContainer container)
	{
		...
		GlyphDefinition.AssertIsTrue(Enum.TryParse<ResourceManager.E_PriceModifierType>(obj.Value.Replace(base.TokenVariables), out var result), "Could not parse Type attribute into an E_PriceModifierType in ModifyCosts");
		Type = result;
	}
}
